...
import com.chores.prvoir.Constants.API_KEY
import com.chores.prvoir.Constants.METRIC_UNIT
import com.chores.prvoir.models.WeatherResponse
import com.chores.prvoir.network.WeatherConfig
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupUI(responseBody: WeatherResponse) {
        for (i in responseBody.weather.indices) {
            ...
            val tvCity: TextView = findViewById(R.id.city_code)
            ...
            when(responseBody.weather[i].icon){
                "01d" -> ivWeather.setImageResource(R.drawable.ic_cloudy)
                "02d" -> ivWeather.setImageResource(R.drawable.ic_sunny)
                "03d" -> ivWeather.setImageResource(R.drawable.ic_rainny)
                "04d" -> ivWeather.setImageResource(R.drawable.ic_snowy)
                "09d" -> ivWeather.setImageResource(R.drawable.ic_thundery)
                "10d" -> ivWeather.setImageResource(R.drawable.ic_cloudy)
                "11d" -> ivWeather.setImageResource(R.drawable.ic_cloudy)
                "13d" -> ivWeather.setImageResource(R.drawable.ic_snowy)
                "01n" -> ivWeather.setImageResource(R.drawable.ic_snowy)
                "02n" -> ivWeather.setImageResource(R.drawable.ic_rainny)
                "03n" -> ivWeather.setImageResource(R.drawable.ic_rainny)
                "10n" -> ivWeather.setImageResource(R.drawable.ic_sunny)
                "11n" -> ivWeather.setImageResource(R.drawable.ic_thundery)
            }
